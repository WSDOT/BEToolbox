...
std::shared_ptr<const WBFL::ReportMgr::ReportSpecification> CGirCompRptView::CreateReportSpecification() const
{
...
std::shared_ptr<WBFL::ReportMgr::ReportBrowser> CGirCompRptView::CreateReportBrowser()
{
