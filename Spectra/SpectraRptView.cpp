...
std::shared_ptr<const WBFL::ReportMgr::ReportSpecification> CSpectraRptView::CreateReportSpecification() const
{
...
std::shared_ptr<WBFL::ReportMgr::ReportBrowser> CSpectraRptView::CreateReportBrowser()
{
