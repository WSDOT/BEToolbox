...
std::shared_ptr<const WBFL::ReportMgr::ReportSpecification> CBoxGdrRptView::CreateReportSpecification() const
{
...
std::shared_ptr<WBFL::ReportMgr::ReportBrowser> CBoxGdrRptView::CreateReportBrowser()
{
