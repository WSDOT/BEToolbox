...
boost::shared_ptr<CReportSpecification> CBoxGdrRptView::CreateReportSpecification()
{
...
boost::shared_ptr<CReportBrowser> CBoxGdrRptView::CreateReportBrowser()
{
...
void CBoxGdrRptView::CreateEditButton()
{
