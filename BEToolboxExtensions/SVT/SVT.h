...
#include "SVTDocTemplate.h"
#include "SVTDoc.h"
#include "SVTView.h"
#include "SVTChildFrame.h"
...
class CSVTTool : public CToolImpl<CSVTTool, &CLSID_SVTTool, IDR_SVT, CExampleToolDoc, CSVTChildFrame, CSVTView, CSVTDocTemplate, IDR_SVT>
{
public:
