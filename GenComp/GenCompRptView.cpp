...
std::shared_ptr<const WBFL::ReportMgr::ReportSpecification> CGenCompRptView::CreateReportSpecification() const
{
...
std::shared_ptr<WBFL::ReportMgr::ReportBrowser> CGenCompRptView::CreateReportBrowser()
{
