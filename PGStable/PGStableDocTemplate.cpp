...
IMPLEMENT_DYNAMIC(CPGStableDocTemplate,CEAFDocTemplate)

CPGStableDocTemplate::CPGStableDocTemplate(UINT nIDResource,
...
CString CPGStableDocTemplate::GetTemplateGroupItemDescription(const CEAFTemplateItem* pItem) const
{
   CString strDescription(_T("Create a new PGStable project (Prestressed Girder Stability Analysis)."));
